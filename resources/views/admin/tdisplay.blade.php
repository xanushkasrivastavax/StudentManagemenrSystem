    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-2">Dashboard <sup>2</sup></div>
            </a>
            ...
            <!-- Nav Item - Utilities Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/user') }}" data-toggle="collapse"
                    data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Add User</span>
                </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <hr class="mt-2 mb-3" />
                    <!-- Content Row -->
                    <h3>Teacher and Student Relationship </h3>
                    <div class="row">
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($student as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->email }}</td>
                                        @foreach ($teacher as $citem)
                                            @if ($citem->cname == $item->cname)
                                                <td>{{ $citem->name }}</td>
                                                <td>{{ $citem->email }}</td>
                                                <td>{{ $citem->cname }}</td>
